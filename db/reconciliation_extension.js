...
export async function getExtensionsByReconciliationId(reconciliationId) {
...
export async function createExtension(reconciliationId, property, value, valueKind, context = null) {
